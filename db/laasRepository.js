...
exports.logRequestResponse=(requestResponseData)=>{
  var defer=Q.defer();
  db.connect("p_logRequestResponse '"+requestResponseData.getData("requestTime").toLocaleString()+"','"+requestResponseData.getData("responseTime").toLocaleString()+"','"+requestResponseData.getData("hostIp")+"',"+requestResponseData.getData("ssid")+","+requestResponseData.getData("txnTypeId")+",'"+requestResponseData.getData("txnNo")+"','"+requestResponseData.getData("responseCode")+"',"+requestResponseData.getData("responseStatus"))
      .then((result)=>{
          defer.resolve(result);
      })
      .catch((err)=>{
